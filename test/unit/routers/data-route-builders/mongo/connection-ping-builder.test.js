...
let chai = require( 'chai' ),
    ...
    ConnectionPingBuilder = require('../../../../../src/routers/data-route-builders/mongo/connection-ping-builder.js'),
...
describe( 'As a developer, I need an API for checking Mongo database connections', function() {
    before(() => {
    });
    beforeEach(() => {
