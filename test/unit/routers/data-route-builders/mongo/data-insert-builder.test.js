...
let chai = require( 'chai' ),
    ...
    DataInsertBuilder = require('../../../../../src/routers/data-route-builders/mongo/data-insert-builder.js'),
...
describe( 'As a developer, I need an API to insert data into the Mongo database', function() {
    before(() => {
    });
    beforeEach(() => {
