...
let chai = require( 'chai' ),
    ...
    DataQueryBuilder = require('../../../../../src/routers/data-route-builders/mongo/data-query-builder.js'),
...
describe( 'As a developer, I need an API for querying data in the Mongo database', function() {
    before(() => {
    });
    beforeEach(() => {
    ...
    it ( 'should gracefully handle an invalid environment', ( ) => {
        ...
        dataQueryBuilder = DataQueryBuilder(mockRouteBuilderBase, { name: 'JUNK', type: 'JUNK' });
        dataQueryBuilder( req, res );
        expect(mockRouteBuilderBase.err).to.not.be.null;
