...
let chai = require( 'chai' ),
    ...
    IndexDropBuilder = require('../../../../../src/routers/data-route-builders/mongo/collection-drop-builder.js'),
...
describe( 'As a developer, I need an API to drop Mongo database collections', function() {
    before(() => {
    });
    beforeEach(() => {
    ...
    it ( 'should gracefully handle invalid request parameters', ( ) => {
        ...
        databaseConnectorManager.databaseConnectors.push({
            name: 'mongo',
            dropCollection: ()  => { return new Promise (( inResolve, inReject ) => { inResolve && inResolve( 1 );});}
        });
