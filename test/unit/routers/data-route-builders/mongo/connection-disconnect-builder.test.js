...
let chai = require( 'chai' ),
    ...
    ConnectionDisconnectBuilder = require('../../../../../src/routers/data-route-builders/mongo/connection-disconnect-builder.js'),
...
describe( 'As a developer, I need an API for disconnecting Mongo database connections', function() {
    before(() => {
    });
    beforeEach(() => {
    ...
    it ( 'should gracefully handle an invalid environment', ( ) => {
        ...
        connectionDisconnectBuilder = ConnectionDisconnectBuilder(mockRouteBuilderBase, { name: 'JUNK', type: 'JUNK' });
        connectionDisconnectBuilder( req, res );
        expect(mockRouteBuilderBase.err).to.not.be.null;
