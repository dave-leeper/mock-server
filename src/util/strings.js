...
Strings.SUCCESS_MESSAGE_FAVORITE_ADDED = 113
Strings.ERROR_MESSAGE_FAVORITE_ADD_FAILED = 114;
Strings.SUCCESS_MESSAGE_FAVORITE_DELETED = 115;
Strings.ERROR_MESSAGE_FAVORITE_DELETE_FAILED = 116;
Strings.SUCCESS_MESSAGE_CART_ITEM_ADDED = 117
Strings.ERROR_MESSAGE_CART_ITEM_ADD_FAILED = 118;
Strings.SUCCESS_MESSAGE_CART_ITEM_DELETED = 119;
Strings.ERROR_MESSAGE_CART_ITEM_DELETE_FAILED = 120;
Strings.COUNT = 121;
