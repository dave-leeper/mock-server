...
Strings.SUCCESS_MESSAGE_FAVORITE_ADDED = 4;
Strings.SUCCESS_MESSAGE_FAVORITE_DELETED = 5;
Strings.SUCCESS_MESSAGE_CART_ITEM_ADDED = 6;
Strings.SUCCESS_MESSAGE_CART_ITEM_DELETED = 7;
Strings.SUCCESS_MESSAGE_BOOKS_ADDED = 8;
...
Strings.ERROR_MESSAGE_ACCOUNT_DOES_NOT_EXIST = 114;
Strings.ERROR_MESSAGE_FAVORITE_ADD_FAILED = 115;
Strings.ERROR_MESSAGE_FAVORITE_DELETE_FAILED = 116;
Strings.ERROR_MESSAGE_CART_ITEM_ADD_FAILED = 117;
Strings.ERROR_MESSAGE_CART_ITEM_DELETE_FAILED = 118;
Strings.ERROR_NO_COLOR = 119;
Strings.ERROR_MESSAGE_SUBTOTAL_REQUIRED = 120;
Strings.ERROR_MESSAGE_TAXES_ARE_REQUIRED = 121;
Strings.ERROR_MESSAGE_TOTAL_REQUIRED = 122;
Strings.ERROR_MESSAGE_BOOK_LIST_REQUIRED = 123;
Strings.ERROR_MESSAGE_INVALID_JSON = 124;
Strings.ERROR_MESSAGE_INVALID_BOOK_ID = 125;
Strings.ERROR_MESSAGE_INVALID_BOOK_ISSUE = 126;
Strings.ERROR_MESSAGE_ERROR_READING_OWNED_BOOKS = 127;
Strings.ERROR_MESSAGE_BOOKS_ADD_FAILED = 128;
Strings.ERROR_MESSAGE_BOOKS_WRITING_BOOKS = 129;
